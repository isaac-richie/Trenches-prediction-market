...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-slate-900 via-gray-900 to-slate-900 border-t border-gray-700 py-4 sm:py-5 px-4 sm:px-6 mt-4 sm:mt-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center gap-3 sm:gap-4 relative z-10">
        {/* Social Icons */}
        <div className="flex gap-4 sm:gap-6 justify-center flex-wrap">
          ...
          <SocialIcon 
            ...
            label="https://github.com/isaac-richie"
          />
        ...
        {/* Copyright */}
        <div className="text-gray-400 text-center border-t border-gray-700 pt-3 sm:pt-4 w-full">
          <p className="text-sm sm:text-lg font-medium mb-1 sm:mb-2">
            © {currentYear} 
            <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent font-bold ml-1 sm:ml-2">
              Trenches Market
            </span>
            . All rights reserved.
          </p>
          <p className="text-xs sm:text-sm text-gray-500 leading-relaxed px-2">
            This interface is for demonstration purposes only. Cryptocurrency trading involves risk.
          </p>
        </div>
      </div>
    </footer>
...
const SocialIcon = ({ href, icon, label }: { 
  ...
  <Link 
    ...
    className="group flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gray-800/50 backdrop-blur-sm border border-gray-600 hover:border-blue-400 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/25"
    aria-label={label}
  >
    <div className="text-gray-400 group-hover:text-blue-400 transition-colors duration-300 group-hover:scale-110">
